  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        id: (Date.now() + 1).toString(),
        role: "assistant",
        content: error.response?.data?.detail || "Sorry, I'm having trouble connecting right now. Please try again or rephrase your question! 🤔",
        timestamp: new Date()
      }
  ...
  return (
    <>
      ...
      {!isOpen && (
        <Button
          onClick={() => {
            window.location.assign("https://codearc.pages.dev/")
          }}
                ...
                >
                  ...
                  {message.suggestions && message.suggestions.length > 0 && (
                    <div className="mt-3 p-2 bg-blue-50 border-l-2 border-blue-400 rounded">
                      <p className="text-xs font-semibold text-blue-800">💡 Next steps:</p>
